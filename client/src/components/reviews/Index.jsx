...
const Index = function ({ user }) {
  ...
  const deleteReview = async (review) => {
    try {
      ...
      toast("The review was an issue deleting the review", {
  ...
  return (
    <Container className="my-5">
      ...
      <div className="row">
              ...
              <div className="card mb-3">
                ...
                <div className="card-header clearfix">
                  <div className="float-left">
                    <h5 className="card-title my-0">{review.title}</h5>
                  </div>

                  <div className="float-right">
                    <small>
                      {review.updatedAt
                        .substring(0, review.updatedAt.length - 8)
                        .replace("T", " ")}
                    </small>
                  </div>
                </div>
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">{review.synopsis}</p>
        ...
        <div id="go-top" className="col text-center">
          <a
            className="smoothscroll btn btn-dark "
            title="Back to Top"
            href="#home"
          >
            Back to Top
